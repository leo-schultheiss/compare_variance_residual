...
def predict_brain_activity(subjectNum, featurename, modality, dirname, layers):
...
if __name__ == "__main__":
    ...
    predict_brain_activity(args.subjectNum, args.featurename, args.modality, args.dirname, args.layers)
