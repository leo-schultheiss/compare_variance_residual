...
import compare_variance_residual.fmri_comparison.common_utils.feature_utils
...
if __name__ == "__main__":
    ...
    # Load the data
    path = compare_variance_residual.fmri_comparison.common_utils.feature_utils.get_prediction_path(language_model, feature, modality, subject, layer=layer)
    print("loading", path)
