...
def run_ridge_pipeline(X, Y, n_samples_train, alphas, cv, number_of_delays, n_targets_batch, n_alphas_batch, n_targets_batch_refit, score_func=himalaya.scoring.r2_score):
    """
